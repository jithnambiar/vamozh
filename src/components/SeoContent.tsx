...
import { BookOpen, Check, HelpCircle, PenTool, TrendingUp, Compass, Heart } from "lucide-react";

export default function SeoContent() {
  return (
    <section className="py-16 bg-[#faf9f6] border-t border-slate-200" id="seo-content">
      <div className="max-w-4xl mx-auto px-4 text-left">
        {/* Visual Header */}
        <div className="flex items-center gap-3 mb-8">
          <div className="w-12 h-12 rounded-2xl bg-purple-50 flex items-center justify-center text-purple-600 border border-slate-200">
        ...
        {/* Content Wrapper */}
        <div className="prose prose-neutral max-w-none text-neutral-700 leading-relaxed space-y-8" id="seo-rich-article">
